% For loading Freq tuning data and plotting curves 3/9/10
...
figure('Color',[1 1 1]);;
Freq = datainfo.curve.FREQrange;
errorbar(Freq,mean(spikecount_sorted2),std(spikecount_sorted2)/sqrt(rep)); % standard error of the mean
title('Freq Tuning');
xlabel('Freq (Hz)');
ylabel('# Spike');